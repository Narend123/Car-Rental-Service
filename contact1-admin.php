...
<tr>
<td align="center" style="padding:5px; background:#5AA547; font-family:Microsoft Tai Le; font-size:40px; color:#FFFFFF">  User Messages</td>
</tr>
</table>
</body>
</html>
...
{
echo"<table border='1' id='reg' style='width:73%'>";
