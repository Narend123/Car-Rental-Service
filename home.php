...
<td><input type="submit" value=" Call Us 365452" name="btn" style="margin-left:px; height:40px; width:200px;border-radius:10px; background-color:black;color:#FFFFFF;font-size:18px; cursor:pointer;"></td>
<td >
<form action="login.php"><input id="lg" type="submit" value="Login/Register" name="btn1" style="margin-left:px; height:40px; width:200px;border-radius:10px;cursor:pointer; background-color:black;color:#FFFFFF;font-size:18px;margin-top:18px" onClick="login.php"> 
</form></td>
...
<img src="images/banner-image.jpg" width="100%" height="80%">
